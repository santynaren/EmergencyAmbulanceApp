...
public class Fire_Information extends AppCompatActivity {

    String Language , longi;
    String latitude , longitude ,lat;
    EditText phone_number_text , landmark_text , reason_text;
    String phonenumber , landmark , type_of_disaster , reason , temp_number ;
    Spinner disaster_spinner ;
    String URL_REGISTER = "http://192.168.1.7/emergencyinsert.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fire__information);
        ...
        disaster_spinner = (Spinner) findViewById(R.id.crime_spinner);
    ...
    public void pass(View view)
    {
        ...
        type_of_disaster = disaster_spinner.getSelectedItem().toString();
        ...
        con.execute(phonenumber,landmark,latitude,longitude,reason,type_of_disaster);
    ...
    class background extends AsyncTask<String,Void,String>
    {
        ...
        protected void onPreExecute() {
            task_req ="http://192.168.43.1/fireinsert.php";
        }

        @Override
        protected String doInBackground(String... args) {
            String p , l ,la ,lo,r,d;
            p = args[0];
            l = args[1];
            la = args[2];
            lo = args[3];
            ...
            try {
                ...
                String data_to_be_added = URLEncoder.encode("phonenumber","UTF-8")+"="+URLEncoder.encode(p,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("disaster_type","UTF-8")+"="+URLEncoder.encode(d, "UTF-8");
        ...
        protected void onPostExecute(String result) {
            ...
            Intent intent = new Intent(Fire_Information.this,Police_final.class);
